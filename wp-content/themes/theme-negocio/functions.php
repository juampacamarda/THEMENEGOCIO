...
acf_add_local_field_group(array(
	'key' => 'group_5e1fb9cd49931',
	'title' => 'cuadro de tarifarios',
	'fields' => array(
		array(
			'key' => 'field_5e1fb9eea2a49',
			'label' => 'titulo cuadro',
			'name' => 'titulo_cuadro',
			'type' => 'text',
			'instructions' => 'colocar titulo ej: "Alquiler Quinta"',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
		...
		array(
			'key' => 'field_5e1fba72a2a4a',
			'label' => 'Meses',
			'name' => 'meses_',
			'type' => 'text',
			'instructions' => 'colocar los meses del servicio vigente',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
			...
			'default_value' => 'mes 1 mes 2 mes 3',
			'placeholder' => '',
			'prepend' => '',
			'append' => '',
			'maxlength' => '',
		...
		array(
			'key' => 'field_5e1fbac1a2a4b',
			'label' => 'año',
			'name' => 'ano',
			'type' => 'text',
			'instructions' => 'colocar año del servicio vigente',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
		...
		array(
			'key' => 'field_5e1fbae1a2a4c',
			'label' => 'frase',
			'name' => 'frase_',
			'type' => 'textarea',
			'instructions' => 'frase amigable para invitar a descargar el tarifario',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
			...
			'default_value' => '<span>Daniel y Valerie, les esperan con muy buena onda para que pasen un día de campo como si estuvieran en su casa.</span>',
			'placeholder' => '',
			'maxlength' => '',
			'rows' => '',
			'new_lines' => 'br',
